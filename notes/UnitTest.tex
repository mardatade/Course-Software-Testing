...
\framesubtitle{\tiny Continuous Integration in Zeiten agiler Programmierung https://heise.de/-1427092}
  \begin{center}
  \dgrafik{\textwidth}{0.3\textwidth}{ConfigurationManagement/illustrations/ContinuousIntegrationEnvironment}
  \end{center}
\end{frame}
...
\begin{frame}
 ...
 \includegraphics[width=0.8cm]{ConfigurationManagement/illustrations/junit.png}
\begin{itemize}
...
\includegraphics[width=0.8cm]{ConfigurationManagement/illustrations/junit.png} in Softwaretechnik:
\begin{itemize}
