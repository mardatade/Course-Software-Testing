...
\begin{center}
\pgfimage[width=\textwidth]{QualityControl/image/ControlFlowGraphs}
\end{center}
\end{frame}
...
\begin{center}
\pgfimage[width=\textwidth]{QualityControl/image/FacultyCalculation}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\pgfimage[width=\textwidth]{QualityControl/image/CylomaticComplexity}
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
\pause
...
%\begin{center}
%\dgrafik{.8\textheight}{.7\textwidth}{QualityControl/image/SeatReservation}
%\end{center}
%\end{frame}
