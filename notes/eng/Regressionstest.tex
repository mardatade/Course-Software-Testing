...
\begin{itemize}
	...
	\item Automated testing (e.g.\ JUnit, Selenium) %\citep{TestAutomation2013}
...
\begin{center}
\pgfimage[width=0.7\textwidth]{images/Qualitaetssicherung/abbildungen/DevOps2016}
\end{center}
\end{frame}
...
\begin{center}
\pgfimage[width=\textwidth]{images/Qualitaetssicherung/abbildungen/DeploymentIncidentsBars}
\end{center}
\end{frame}
