...
\only<beamer>{  \begin{center}
  \includegraphics[width=.85\textwidth]{QualityControl/illustrations/Bug}
  \end{center}
}
\end{frame}
...
\begin{center}
\includegraphics[width=\textwidth]{QualityControl/illustrations/ValidationVerification}
\end{center}
\end{frame}
...
\begin{center}
\pgfimage[width=\textwidth]{QualityControl/illustrations/VModel}
\end{center}
...
%\framesubtitle{\citep{Sommerville2018}}
  %\begin{center}
  %\includegraphics[width=1.05\textwidth]{QualityControl/illustrations/TestProcess}
  %\end{center}
...
\frametitle{Black-Box vs. White-Box Testing}
  \begin{center}
  \includegraphics[width=.8\textwidth]{QualityControl/illustrations/BlackBoxAndWhiteBoxTesting}
  \end{center}
\end{frame}
