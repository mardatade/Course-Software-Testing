...
\begin{itemize}
  ...
  \item Viele Module können gar nicht isoliert getestet werden.
  \item Also: Vorgehensweise zum Test komplexer Systeme (modulares Testen):
    \begin{itemize}
      ...
      \item Inkrementeller Integrationstest mehrerer Komponenten im Kontext.
...
\begin{itemize}
	\item Inkrementelle Tests können entsprechend den Benutzt- und Kompositions-Hierarchien bottom-up oder top-down erfolgen; natürlich auch jo-jo. 
	\item Eine hierarchische Architektur ist dabei sehr förderlich.
\end{itemize}
\end{frame}
